...
instruction_template['sll']=Tinstruction('sll','R','(?P<rd>.*?), *(?P<rt>.*?), *(?P<shamt>.*)','000000')
instruction_template['srl']=Tinstruction('srl','R','(?P<rd>.*?), *(?P<rt>.*?), *(?P<shamt>.*)','000010')
instruction_template['sra']=Tinstruction('sra','R','(?P<rd>.*?), *(?P<rt>.*?), *(?P<shamt>.*)','000011')
